...
public interface SourceMapGenerator {
	 ...
	 * @throws IOException
	 */
	void appendIndexMapTo(Appendable out, String name, List<SourceMapSection> sections) throws IOException;

	/**
	 * Resets the source map for reuse. A reset needs to be called between each
	 ...
	 * 
	 * @param sourceName          The file name to use in the generate source map to
	 *                            represent this source.
	 * @param symbolName          The symbol name associated with this position in
	 *                            the source map.
	 * @param sourceStartPosition The starting position in the original source for
	 *                            represented range outputStartPosition to
	 *                            outputEndPosition in the generated file.
