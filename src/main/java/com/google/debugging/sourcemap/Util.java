...
public class Util {
	...
	private static String escapeString(String s, char quote, String doublequoteEscape, String singlequoteEscape,
	 ...
	 * @param out       The buffer to which the hex representation should be
	 *                  appended.
	 */
	...
	public static <T> T getLast(ArrayList<T> entries) {
